#!/bin/bash
# nvm.sh — Standalone NVM migration helper for macOS
#
# Usage:
#   Install NVM:   bash ~/.dotfiles/macos/nvm.sh install
#   Uninstall NVM: bash ~/.dotfiles/macos/nvm.sh uninstall
...
_uninstall() {
  ...
  # Source nvm to get list of installed versions
